  ...
  return (
    <>
      ...
      <div
        ...
        onClick={onClose}
      />
      {/* Panel z-50 — siempre por encima del backdrop y de cualquier toast */}
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div
          className={`w-full ${widths[size]} bg-surface-container-lowest rounded-xl editorial-shadow overflow-hidden pointer-events-auto`}
